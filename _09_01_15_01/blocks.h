class Block
{
  ...
  public:
    ...
    Block(CRGB* leds, int blockSize)
    {
      this->leds = leds;
      this->blockSize = blockSize;
    }
    
    Block(CRGB* leds, int blockSize, bool isFirst)
    {
      this->leds = leds;
...
/*
    Block(CRGB* leds, int blockSize, bool isFirst  CRGB blockColor)
    {
      this->leds = leds;
      this->isFirst = isFirst;
      this->blockSize = blockSize;
