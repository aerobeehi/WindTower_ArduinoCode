...
/////////////////////////////////////////////////////////
// Sets the previous and next blocks as well as the first
// and last LED based on length argument. 
...
// Turns on the block of LEDs to the correct color.
    void turnOn()
    {
